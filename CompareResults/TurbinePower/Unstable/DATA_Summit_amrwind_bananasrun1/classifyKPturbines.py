...
summitcsv    = '../../../../UnstableABL_farmrun1/UnstableABL_farmrun_turbines.csv'
...
for d in allcategories:
    print("  %s:"%d['label'])
    print("    filelist:")
    for t in turbinecategorylist[d['label']]:
        globpattern="%s_OpenFAST3p3_NREL2p8-127.bugfix/*.out"%t
        outfile = glob.glob(globpattern)
        print("    - %s"%outfile[0])
