...
NCFILE=/gpfs/alpine/cfd162/scratch/lcheung/AWAKEN/testturbs/post_processing/BR_ioflow_64500.nc
OUTFILE=BR_ioflow_mean_wturb.pkl
ISTART=360
DT=60
IEND=1010
...
NCFILE=/gpfs/alpine/cfd162/scratch/lcheung/AWAKEN/UnstableABL1_farmrun1_noturbs/post_processing/BR_ioflow_64500.nc
OUTFILE=BR_ioflow_mean_noturb.pkl
# Run the script
python assemblepkl.py $NCFILE `seq $ISTART $DT $IEND` $OUTFILE --vxvar $VXVAR --vyvar $VYVAR --vzvar $VZVAR --overwrite --inflow -v
